...
const Main = () => {
  return (
    <>
        ...
        <div className='hidden md:block md:min-h-screen bg-2 p-20'>
          <div className=" z-20 card w-96 bg-white border border-[#e6122b] rounded-none absolute">
            <div className="card-body">
              <h2 className="card-title">About Me</h2>
              <p className='text-left'>Eat. Sleep. Repeat.</p>
              <p className='text-left'>Eat. Sleep. Repeat.</p>
              <p className='text-left'>Eat. Sleep. Repeat.</p>
              <p className='text-left'>Eat. Sleep. Repeat.</p>
              <p className='text-left'>Eat. Sleep. Repeat.</p>
          ...
          <div className=" mt-2 ml-2 card w-96 bg-[#000] shadow-xl rounded-none absolute">
            <div className="card-body">
              <h2 className="card-title">About Me</h2>
              <p className='text-left'>Eat Sleep Repeat</p>
              <p className='text-left'>Eat. Sleep. Repeat.</p>
        ...
        <div className='hidden md:block md:min-h-screen bg p-20'>
          <div className=" z-20 card w-96 bg-white border border-[#e6122b] rounded-none absolute">
            <div className="card-body">
              <h2 className="card-title">About Me</h2>
              <p className='text-left'>Eat. Sleep. Repeat.</p>
