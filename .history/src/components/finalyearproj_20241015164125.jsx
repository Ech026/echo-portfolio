  ...
  return (
    ...
    <div className='hidden md:block md:min-h-screen bg-fixed p-20'>
          <div className='flex justify-evenly text-left'>
            ...
            <div className='mb-10'>
                <div className=" z-20 card bg-white border border-[#e6122b] rounded-none">
                  <div className='flex'>
