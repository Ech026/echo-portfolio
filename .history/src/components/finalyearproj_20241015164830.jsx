          ...
          <div className='flex justify-evenly text-left'>
            ...
            <div className='mb-10 mx-36'>
                <div className="mt-8 card bg-white border border-[#e6122b] rounded-none">
                  ...
                  <div className="mockup-code m-4 mt-24">
                    <pre data-prefix=">" className="text-warning"><code>Date: 2024</code></pre>
                    <pre data-prefix="$"><code>React-Native</code></pre>
                    <pre data-prefix=">" className="text-warning"><code>Express</code></pre>
                    <pre data-prefix=">" className="text-success"><code>MongoDB</code></pre>
                    <pre data-prefix="$"><code>NodeJs</code></pre>
