...
const finalyearproj = () => {
  return (
    ...
    <div className='m-10 mt-16'>
                <div className=" mt -34 z-20 card w-[600px] bg-white border border-[#e6122b] rounded-none absolute">
                ...
                <div className=" mt-56 ml-2 card w-[600px] bg-[#000] shadow-xl rounded-none ">
                  <div className="card-body">
                  <h2 className="card-title">Education</h2>
