...
const project = (props) => {
  return (
    <>
    <div className="z-20 card card-compact bg-base-100 w-96 shadow-xl m-6 rounded-none">
        <figure>
            <img
    ...
    <div className="card card-compact bg-base-100 w-96 shadow-xl m-6 rounded-none">
        <figure>
            <img
            src="https://img.daisyui.com/images/stock/photo-1606107557195-0e29a4b5b4aa.webp"
            alt="Shoes" />
