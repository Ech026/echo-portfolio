...
const Main = () => {
  return (
    <>
        ...
        <div className=" card w-96 bg-white shadow-xl rounded-none">
          <div className="card-body">
              <h2 className="card-title">About Me</h2>
              <p className='text-justify'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Doloremque inventore facere ex sunt tempora eos voluptatem, quas libero at itaque necessitatibus ratione, culpa reprehenderit voluptate perferendis iste tempore, accusantium aliquid?</p>
